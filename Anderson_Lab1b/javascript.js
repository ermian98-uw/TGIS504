...
/* Initialize Map */
mapboxgl.accessToken = 'pk.eyJ1IjoiZXJtaWFuOTgiLCJhIjoiY2tod3I5NGozMXloczJ1bWpoMWtmeDR1YyJ9.em9VpowzKU06_3X8u-Gz2g';
...
/* Add the hospital and library layers */
...
map.on('click', 'libraries', function(f) {
  ...
  /* Add the library popups */
  popup.setLngLat(refLibrary.geometry.coordinates)
    .setHTML('<b>' + refLibrary.properties.NAME + ':</b><br>The nearest hospital is ' + nearestHospital.properties.NAME + ', located at ' + nearestHospital.properties.ADDRESS + ". It is " + distance.toFixed(2) + " miles away as the crow flies.")
    .addTo(map);
});
